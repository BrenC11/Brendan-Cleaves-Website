...
export const projects: Project[] = [
  ...
  {
    title: "Death Koolaid - Kids",
    slug: "kids-turn",
    category: "music-videos",
    year: "2021",
    logline: "A kinetic performance piece set in one take.",
    description:
      "A music video for Death Koolaid built around forward motion and raw performance energy. The visual approach stays tight and urgent to match the track.",
    runtime: "4:05",
    role: "Director",
    accent: "#2d3d8e",
  ...
  },
  {
    ...
    slug: "death-koolaid-the-second-rule",
    category: "music-videos",
    year: "2014",
    logline: "UKMVA nominated music video.",
    description:
      "A performance-led music video for Death Koolaid that earned a UKMVA nomination.",
    runtime: "TBD",
    role: "Director",
    accent: "#3b2f68",
  ...
  },
  {
    ...
    slug: "viii-fear-nothing",
    category: "music-videos",
    year: "TBD",
    logline: "A dark performance-led music video with high visual intensity.",
    description:
      "A stylized music video for VIII that leans into bold texture, atmosphere, and performance.",
    runtime: "TBD",
    role: "Director",
    accent: "#4b1f2e",
    embedSrc: "https://player.vimeo.com/video/247348043?h=1826bab0e0&title=0&byline=0&portrait=0",
    thumbnailSrc: "/thumbnails/fear.jpg.webp",
  },
  {
    title: "THE DOGBONES - HEY CHIHUAHUA",
    slug: "the-dogbones-hey-chihuahua",
    category: "music-videos",
    year: "TBD",
    logline: "A fast, playful music video driven by performance and attitude.",
    description:
      "A high-energy music video for The Dogbones, cut for pace with a bold, performance-first style.",
    runtime: "TBD",
    role: "Director",
    accent: "#6a3d2a",
  ...
  },
  {
    ...
    slug: "friction-ft-josh-barry-freaks",
    category: "music-videos",
    year: "TBD",
    logline: "A kinetic music video with a dark, performance-led edge.",
    description:
      "A stylized music video for Friction Ft Josh Barry, built around momentum, texture, and performance intensity.",
    runtime: "TBD",
    role: "Director",
    accent: "#2f4f6a",
...
export const aboutBio = {
  ...
  paragraphs: [
    ...
    "Since then, I've directed music videos and commercials for both major brands and independent artists, always focused on bringing authentic, memorable stories to life. I wrote and directed my first genre short, ROGER, as a proof of concept for a feature, starring John Bradley (Game of Thrones) and comedian Seann Walsh. To date, I've directed 12 short films, including a documentary, with screenings at over one hundred prestigious festivals worldwide, including many BAFTA and Academy-qualifying events, earning multiple Melies d'Argent nominations along the way.",
